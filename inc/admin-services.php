<?php
/**
 * Services Settings Page Callback (8 Custom Service Buttons)
 */
...
function kish_harmony_services_settings_page() {
	...
	<div class="wrap">
		...
		<p>می‌توانید دکمه‌های خدمات را مدیریت کرده، عنوان، ایموجی/آیکون یا آدرس تصویر سفارشی و برگه مربوطه را مشخص نمایید.</p>
		...
		<form method="post" action="">
			...
			<div id="services-repeater">
				<?php foreach ( $services as $idx => $service ) : ?>
					<div class="service-item-row" style="background:#fff; border:1px solid #ccc; padding:15px; margin-bottom:15px; border-radius:8px;">
						<h3 style="margin-top:0;">خدمت #<?php echo $idx + 1; ?></h3>
